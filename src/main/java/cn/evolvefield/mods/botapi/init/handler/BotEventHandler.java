...
public class BotEventHandler {
    ...
    private static void atPlayerInGame(PrivateMessageEvent event, String senderName, String[] ctx, String playerName) {
        if (ctx.length == 2) {
            TranslationTextComponent textcomponenttranslation = new TranslationTextComponent("commands.message.display.incoming",
                    senderName, new StringTextComponent(ctx[1]));
