...
public class SendMessage {
      public void Private(long user_id, String message) {
            try {
                  ...
                  URL url = new URL("http://" + BotConfig.INSTANCE.getSendHOST() + ":" + BotConfig.INSTANCE.getSendPORT() +
      ...
      public static JSONObject getProfile(long group, long userId) {
            ...
            try {
                  String resp = HttpRequest.post("http://" + BotConfig.INSTANCE.getSendHOST() + ":" + BotConfig.INSTANCE.getSendPORT() +
